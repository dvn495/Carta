...
const songsList: Song[] = [
  ...
  },
  {
    ...
    src: '/songs/Andrés Cepeda, Sebastian Yatra - Magia (Letra).mp3',
  ...
  },
  {
    ...
    src: '/songs/Billie Eilish - BIRDS OF A FEATHER (Official Lyric Video).mp3',
  ...
  },
  {
    ...
    src: '/songs/Accidentally In Love (From Shrek 2 Soundtrack).mp3',
  ...
  },
  {
    ...
    src: "/songs/Elvis Presley - Can't Help Falling In Love (Official Audio).mp3",
